  ...
  return (
    <>
      <div className="pt-20 md:pt-16 bg-mobile">
        ...
        <div className="h-full grid lg:grid-cols-[minmax(0,1fr),50vw] overflow-hidden">
          <TitleAndShit />
          <div className="overflow-hidden relative bg-gradient-to-tr from-sky-500 via-blue-700 to-blue-950 hidden lg:flex">
            <div
              className="size-0"
              style={{
